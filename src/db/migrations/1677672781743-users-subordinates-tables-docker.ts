...
export class usersSubordinatesTables21677672781743 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('Admin', 'Boss', 'User')`);
    await queryRunner.query(
